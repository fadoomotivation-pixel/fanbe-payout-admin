...
import InventoryPricing from './pages/inventory/InventoryPricing'
...
import BrokerHierarchy from './pages/brokers/BrokerHierarchy'
...
import SupportTickets from './pages/cms/SupportTickets'
import WithdrawalReview from './pages/cms/WithdrawalReview'
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<ProtectedRoute><AppShell /></ProtectedRoute>}>
        ...
        <Route path="brokers/hierarchy" element={<BrokerHierarchy />} />
